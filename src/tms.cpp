...
const int MAX_FIG = 20;
const int NUMBER_OF_BITS = 31;

int c[MAX_DIMENSION][MAX_FIG][MAX_FIG/*!*/]; // /*!*/ - индексация как в си, т.е. C(MAXDIM, MAXFIG, 0:MAXFIG-1)
int count[MAX_FIG/*!*/], d[MAX_DIMENSION][MAX_FIG];
int nextq[MAX_DIMENSION], qpow[MAX_FIG];
int dimen, nfigs;
double recip;
